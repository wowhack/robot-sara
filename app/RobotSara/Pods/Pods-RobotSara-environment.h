...
// StringScore
#define COCOAPODS_POD_AVAILABLE_StringScore
#define COCOAPODS_VERSION_MAJOR_StringScore 0
#define COCOAPODS_VERSION_MINOR_StringScore 0
#define COCOAPODS_VERSION_PATCH_StringScore 1
