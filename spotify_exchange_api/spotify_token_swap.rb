...
CLIENT_ID = "2e9be8332fd743f3ab202f46eaa44165"
CLIENT_SECRET = "58c9c8fc99554bffb84125c1581f13ef"
CLIENT_CALLBACK_URL = "robot-sara://callback"
AUTH_HEADER = "Basic " + Base64.strict_encode64(CLIENT_ID + ":" + CLIENT_SECRET)
SPOTIFY_ACCOUNTS_ENDPOINT = URI.parse("https://accounts.spotify.com")
SPOTIFY_PROFILE_ENDPOINT = URI.parse("https://api.spotify.com")

set :port, 1026 # The port to bind to.
set :bind, '0.0.0.0'
